...
const buildBarcodeLabelsHtml = (labels: Array<{ item: MenuItem; quantity: number }>, autoPrint = true) => {
  ...
  return [
    ...
    ".barcode-label { width: 50mm; height: 20mm; box-sizing: border-box; padding: 0.7mm 1.5mm 0.45mm; overflow: hidden; break-after: page; page-break-after: always; background: #fff; }",
    ".label-head { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 1.1mm; align-items: center; height: 7mm; }",
    ".label-name { font-size: 12px; line-height: 1.05; font-weight: 700; max-height: 6.9mm; overflow: hidden; word-break: break-word; }",
    ".label-price { font-family: Arial, sans-serif; font-size: 15px; line-height: 1; font-weight: 700; white-space: nowrap; }",
    ".label-bars { height: 6.7mm; margin-top: 0.2mm; }",
